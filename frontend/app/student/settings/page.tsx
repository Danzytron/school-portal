...
import { Lock, Save, ShieldCheck, KeyRound, Shield } from 'lucide-react';
...
export default function StudentSettingsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!currentPassword) {
      setError('Current authentication password is required.');
      return;
    }
    ...
    try {
      ...
      setToastMessage('Security password successfully updated.');
      setCurrentPassword('');
      setNewPassword('');
      setConfirmPassword('');
  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto font-sans">
      <PageHeader 
        title="Security & Account Access Control" 
        subtitle="Manage student authentication credentials, password security, and access privacy."
        badge="Official Security Settings"
      />
